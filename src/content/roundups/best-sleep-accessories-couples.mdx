...
<FAQ
  items={[
    { q: "Is it weird to use separate blankets?", a: "In Scandinavia, separate duvets are the norm — most couples there have always used individual blankets on a shared bed. Verified reviews from couples who made the switch consistently describe sleeping better without feeling less connected. Try it for a week." },
