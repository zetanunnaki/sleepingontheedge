    ...
    faqs: [
      {
        ...
        a: "The Dohm. Tinnitus sufferers are uniquely sensitive to audio loops, and the Dohm is physically incapable of looping because the sound is generated by a real moving fan. Verified tinnitus reviews consistently rank the Dohm above electronic alternatives.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Both work. Verified reviews from back pain sufferers show roughly equal satisfaction in their respective price categories. The decision comes down to feel preference and budget, not pain outcome.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Verified reviews and lens spectrum data suggest yes — both filter the same approximate range. The premium price of Swannies pays for design, comfort, and brand, not better lens function.",
      },
      {
      ...
      },
      {
        ...
        a: "For evening screen use specifically, yes. Verified reviews consistently report easier sleep onset when wearing blue blockers in the 2–3 hours before bed. They're a small but real intervention.",
      },
    ],
  },
  {
